...
class Complex {
// публичные поля с полями и методами (у нас просто с методами),
  //доступными пользователю  вашего класса
public:
  ...
  // Следующие функции рассмотрим на занятии вместе
  //(можно попробовать самим вперёд)
